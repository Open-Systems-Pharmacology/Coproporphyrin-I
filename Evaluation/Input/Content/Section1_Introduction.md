...
This Coproporphyrin-I model is intended to be used as an endogenous marker to estimate the inhibition constants for OATP1B1 perpetrators.
...
- transport by OATP1B1/1B3 (modeled as a single lumped OATP1B transporter),
- transport by MRP2
