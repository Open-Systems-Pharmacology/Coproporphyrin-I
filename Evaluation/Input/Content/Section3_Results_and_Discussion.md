...
The model quantifies synthesis of Coproporphyrin-I in the liver, excretion via urine through glomerular filtration, influx to liver via OATP1B1/1B3 and excretion to bile via MRP2.
...
1. the final model input parameters for the building blocks: [Section 3.1](#31-coproporphyrin-i-final-input-parameters).
2. the overall goodness of fit: [Section 3.2](#32-coproporphyrin-i-diagnostics-plots).
